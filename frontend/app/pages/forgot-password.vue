...
<template>
  <div class="min-h-screen bg-gray-100 px-8 pt-24">
    <div class="mx-auto max-w-sm rounded-lg border border-gray-50 bg-white p-8 shadow">
      <h1 class="mb-4 text-center text-2xl font-semibold text-gray-900">Forgot Password?</h1>

      <form v-if="!success" @submit.prevent="requestPasswordReset" class="flex flex-col gap-4">
        <p class="text-sm text-gray-700">We'll send you an email with a link to reset your password.</p>
      ...
      <div v-else class="flex flex-col gap-2">
        <p class="text-sm text-gray-700">If your user exists, you will receive an email with a link to reset your password.</p>
