...
<template>
  <div class="bg-white p-6 rounded-lg shadow">
    <h2 class="text-xl font-bold mb-4">{{ initialTask ? 'Edit Task' : 'Create New Task' }}</h2>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <div class="space-y-4">
        ...
        <div v-if="task.type === 'free_text'">
          ...
          />
          <p class="mt-1 text-sm text-gray-500">This will be used as a reference for grading.</p>
        </div>
      </div>
    </div>
